<?php 
		...
		function ValidateSubmission()
    {
        ...
        $validator->addValidation("about","req","About is important to tell about the shared link");
        $validator->addValidation("link","req","Link is very required");
        $validator->addValidation("catagory","req","Your post must be catagorized, put the catagory");
        $validator->addValidation("type","req","Your post must be catagorized, put the catagory type");
